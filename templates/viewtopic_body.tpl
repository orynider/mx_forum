...
<table width="100%" cellspacing="0" cellpadding="2" border="0">
  <tr> 
	...
	<td align="left" valign="middle" width="100%"><span class="nav">&nbsp;&nbsp;&nbsp;<a href="{UU_INDEX}" class="nav">{L_INDEX}</a> 
...
<table  width="100%" cellspacing="0" cellpadding="4" border="0">
	...
	<tr> 
		<td class="{postrow.ROW_CLASS}" width="150" align="left" valign="middle"><span class="nav"><a href="{U_VIEW_TOPIC}#top" class="nav">{L_BACK_TO_TOP}</a></span></td>
...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
  <tr> 
	...
	<td align="left" colspan="2" valign="middle" width="100%"><span class="nav">&nbsp;&nbsp;&nbsp;<a href="{UU_INDEX}" class="nav">{L_INDEX}</a> 
	  &raquo; <a href="{U_VIEW_FORUM}" class="nav">{FORUM_NAME}</a></span></td>
  </tr>
  <tr>
	<td align="left" ><span class="nav">{PAGE_NUMBER}</span></td>
	<td align="right" colspan="2"valign="top" nowrap="nowrap"><span class="gensmall">{S_TIMEZONE}</span><br /><span class="nav">{PAGINATION}</span> 
	  </td>
  </tr>
</table>
...
<table width="100%" cellspacing="2" border="0" align="center">
  <tr> 
	<td width="40%" valign="top" nowrap="nowrap" align="left"><span class="gensmall">{S_WATCH_TOPIC}</span><br />
	  &nbsp;<br />
	  {S_TOPIC_ADMIN} <br />
	  	<form action="{TOPIC_TYPE_ACTION}" method="get" name="select_icon" >
		{TOPIC_TYPE_FOLDER}
		{TOPIC_TYPE_HIDDEN}
