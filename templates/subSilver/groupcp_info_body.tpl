...
<table  width="100%" cellspacing="0" cellpadding="4" border="0">
	<tr> 
		<td class="row3" colspan="6" height="25">&nbsp;
		<span class="newsbutton" onClick="rollup_contract(this, 'phpbbCategory_group_info', '{U_CAT_NAV}');">
    		<!-- BEGIN switch_cat_on -->
    			<img src="{U_CAT_NAV}contract.gif" border="0" />
    		<!-- END switch_cat_on -->
    		<!-- BEGIN switch_cat_off -->
    			<img src="{U_CAT_NAV}expand.gif" border="0" />
    		<!-- END switch_cat_off -->
    		</span>&nbsp;
    		{L_GROUP_INFORMATION}: {GROUP_NAME}</td>
	</tr>

  	<!-- BEGIN switch_cat_on -->
  	<tbody id="phpbbCategory_group_info" style="display: ;">
  	<!-- END switch_cat_on -->
  	
	<!-- BEGIN switch_cat_off -->
  	<tbody id="phpbbCategory_group_info" style="display: none;">
  	<!-- END switch_cat_off -->	
...
<table width="100%" cellpadding="4" cellspacing="0" border="0">
	...
	<tr> 
		<td class="catSides" colspan="7" height="28"><span class="cattitle">{L_GROUP_MODERATOR}</span></td>
	</tr>
	...
	<tr> 
	<td class="catSides" colspan="7" height="28">
	<span class="newsbutton" onClick="rollup_contract(this, 'phpbbCategory_member_info', '{U_CAT_NAV}');">
    		<!-- BEGIN switch_catt_on -->
    			<img src="{U_CAT_NAV}contract.gif" border="0" />
    		<!-- END switch_catt_on -->
    		<!-- BEGIN switch_catt_off -->
    			<img src="{U_CAT_NAV}expand.gif" border="0" />
    		<!-- END switch_catt_off -->
    		</span>&nbsp;
    		<span class="cattitle">{L_GROUP_MEMBERS}</span></td>

  	<!-- BEGIN switch_catt_on -->
  	<tbody id="phpbbCategory_member_info" style="display: ;">
  	<!-- END switch_catt_on -->
  	
	<!-- BEGIN switch_catt_off -->
  	<tbody id="phpbbCategory_member_info" style="display: none;">
  	<!-- END switch_catt_off -->
