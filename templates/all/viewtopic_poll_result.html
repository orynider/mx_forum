			...
			<tr> 
			  ...
			  <td> 
				<table cellspacing="0" cellpadding="0" border="0">
				  <tr> 
					<td><img src="{poll_option.POLL_IMG_URL}vote_lcap.gif" width="4" alt="" height="12" /></td>
					<td><img src="{poll_option.POLL_IMG_URL}voting_bar.gif" width="{poll_option.POLL_OPTION_IMG_WIDTH}" height="12" alt="{poll_option.POLL_OPTION_PERCENT}" /></td>
					<td><img src="{poll_option.POLL_IMG_URL}vote_rcap.gif" width="4" alt="" height="12" /></td>
				  </tr>
				</table>
			  </td>
